...
public class BankTransSericeimpl  implements BankTransactionService {
	...
	BankTransactionRepo bankTransRepo;
	  ...
	  @Override
	    public List<BankTransaction> getTransactionsByCustomerAccountNumber(String customerAccountNumber) {
	        return bankTransRepo.findByToAccount(customerAccountNumber);
	    }
