...
public class AddToCartImpl implements AddToCartService {
	...
	public List<AddToCart> getCustomerCartById(Long customerId) {
	 ...
	 @Override
	    public List<AddToCart> getCartsByCustomerIdAndCarId(Long customerId, Long carId) {
	        return (List<AddToCart>) addToCartRepo.findByCustomerIdAndCarId(customerId, carId);
	    }
