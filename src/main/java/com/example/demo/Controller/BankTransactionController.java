...
public class BankTransactionController {
	...
	public ResponseEntity<Object> getAllBankTransactions(){
	 ...
	 @GetMapping(value = "/getTransactionByCustomerAccountNumber/{customerAccountNumber}")
	    public ResponseEntity<Object> getTransactionByCustomerAccountNumber(@PathVariable String customerAccountNumber) {
	        List<BankTransaction> transactions = bankTransService.getTransactionsByCustomerAccountNumber(customerAccountNumber);

	        if (transactions != null && !transactions.isEmpty()) {
	            return new ResponseEntity<>(transactions, HttpStatus.OK);
	        } else {
	            return new ResponseEntity<>("No transactions found for the provided account number", HttpStatus.NOT_FOUND);
	        }
	    }
